...
type Game1 () as this =
    ...
    override this.Draw (gameTime) =
        ...
        // Demo 1
        this.Sierpinski(new Vector2(200.0f, 413.0f), new Vector2(400.0f, 67.0f), new Vector2(180.0f, 320.0f), 4);
        this.Sierpinski(new Vector2(200.0f, 413.0f), new Vector2(400.0f, 67.0f), new Vector2(600.0f, 413.0f), 5);

        // Demo 2
        // this.Sierpinski(new Vector2(300.0f, 440.0f), new Vector2(500.0f, 300.0f), new Vector2(300.0f, 200.0f), 5);
        // this.Sierpinski(new Vector2(300.0f, 440.0f), new Vector2(100.0f, 300.0f), new Vector2(300.0f, 200.0f), 5);

        // Demo 3
        // this.Sierpinski(new Vector2(300.0f, 40.0f), new Vector2(300.0f, 240.0f), new Vector2(500.0f, 240.0f), 5);
        // this.Sierpinski(new Vector2(300.0f, 40.0f), new Vector2(300.0f, 240.0f), new Vector2(100.0f, 240.0f), 5);
        // this.Sierpinski(new Vector2(300.0f, 440.0f), new Vector2(300.0f, 240.0f), new Vector2(500.0f, 240.0f), 5);
        // this.Sierpinski(new Vector2(300.0f, 440.0f), new Vector2(300.0f, 240.0f), new Vector2(100.0f, 240.0f), 5);
